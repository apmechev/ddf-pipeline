...
def ddf_image(imagename,mslist,cleanmask=None,cleanmode='MSMF',ddsols=None,applysols=None,threshold=None,majorcycles=3,previous_image=None,use_dicomodel=False,robust=0,beamsize=None,reuse_psf=False,reuse_dirty=False,verbose=False,saveimages=None,imsize=None,cellsize=None,uvrange=None,colname='DATA',peakfactor=0.1,dicomodel_base=None,options=None,singlefreq=False,do_decorr=None,donorm=True,dirty_from_resid=False,clusterfile=None):
...
if __name__=='__main__':
    ...
    make_mask('image_dirin_MSMF_deeper1.app.restored.fits',o['ga'])
    ...
    make_mask('image_dirin_MSMF_deeper2.app.restored.fits',o['ga'])
    ...
    if make_model('image_dirin_MSMF_deeper3.app.restored.fits.mask.fits','image_dirin_MSMF'):
    ...
    mask_dicomodel('image_dirin_MSMF_deeper3.DicoModel','image_dirin_MSMF_deeper3.app.restored.fits.mask.fits','image_dirin_MSMF_deeper3.DicoModel')

    killms_data('image_dirin_MSMF_deeper3',o['mslist'],'killms_p1',colname=colname,dicomodel='image_dirin_MSMF_deeper3.DicoModel')
...
#        run_bootstrap(o)
    ...
    # Image full bandwidth to create a model
    threshold1 = 20e-3
    ddf_image('image_phase1_MSMF',o['mslist'],cleanmask='image_dirin_MSMF_deeper3.app.restored.fits.mask.fits',cleanmode='MSMF',threshold=threshold1,majorcycles=10,robust=o['robust'],ddsols='killms_p1',applysols='P',colname=colname,use_dicomodel=True,dicomodel_base='image_dirin_MSMF_deeper3')

    make_mask('image_phase1_MSMF.app.restored.fits',o['ga'])

    f = pyfits.open('image_phase1_MSMF.app.restored.fits')
    noisearray = f[0].data.flatten()
    maxpixel = np.max(noisearray)
    noisearray = np.random.permutation(noisearray)[:10000]
    noisepix = np.array(filter(lambda x: abs(x) > 10E-8,noisearray))
    ...
    f = pyfits.open('image_phase1_MSMF.app.restored.fits.noisemap.fits')
    dataarray = f[0].data.flatten()
    dataarray = np.random.permutation(dataarray)[:10000]
    #dataarray = np.array(filter(lambda x: abs(x) > minthreshold,dataarray))
    dataarray = np.random.permutation(dataarray)[:10000]
    ...
    update_cleanmask('image_phase1_MSMF.app.restored.fits.mask.fits','image_phase1_MSMF.app.restored.fits.noisemap.fits','image_phase1_MSMF.app.restored.fits.mask.fits_deeper1',threshold2)
    ddf_image('image_phase1_MSMF_deeper1',o['mslist'],cleanmask='image_phase1_MSMF.app.restored.fits.mask.fits_deeper1',cleanmode='MSMF',threshold=5*threshold2,majorcycles=10,robust=o['robust'],reuse_psf=True,use_dicomodel=True,previous_image='image_phase1_MSMF',ddsols='killms_p1',applysols='P',colname=colname)
    make_mask('image_phase1_MSMF_deeper1.app.restored.fits',o['ga'])
    
    update_cleanmask('image_phase1_MSMF_deeper1.app.restored.fits.mask.fits','image_phase1_MSMF_deeper1.app.restored.fits.noisemap.fits','image_phase1_MSMF.app.restored.fits.mask.fits_deeper2',threshold3)
    ddf_image('image_phase1_MSMF_deeper2',o['mslist'],cleanmask='image_phase1_MSMF.app.restored.fits.mask.fits_deeper2',cleanmode='MSMF',threshold=5*threshold3,majorcycles=10,robust=o['robust'],reuse_psf=True,use_dicomodel=True,previous_image='image_phase1_MSMF_deeper1',ddsols='killms_p1',applysols='P',colname=colname)
    make_mask('image_phase1_MSMF_deeper2.app.restored.fits',o['ga'])
    
    update_cleanmask('image_phase1_MSMF_deeper2.app.restored.fits.mask.fits','image_phase1_MSMF_deeper2.app.restored.fits.noisemap.fits','image_phase1_MSMF.app.restored.fits.mask.fits_deeper3',threshold4)
    ddf_image('image_phase1_MSMF_deeper3',o['mslist'],cleanmask='image_phase1_MSMF.app.restored.fits.mask.fits_deeper3',cleanmode='MSMF',threshold=5*threshold4,majorcycles=10,robust=o['robust'],reuse_psf=True,use_dicomodel=True,previous_image='image_phase1_MSMF_deeper2',ddsols='killms_p1',applysols='P',colname=colname)
    make_mask('image_phase1_MSMF_deeper3.app.restored.fits',o['ga'])
    ...
    mask_dicomodel('image_phase1_MSMF_deeper3.DicoModel','image_phase1_MSMF_deeper3.app.restored.fits.mask.fits','image_phase1_MSMF_deeper3_masked.DicoModel')
    # Calibrate off the model
    killms_data('image_phase1_MSMF_deeper3',o['mslist'],'killms_ap1',colname=colname,dicomodel='image_phase1_MSMF_deeper3_masked.DicoModel')
    ...
    f = pyfits.open('image_ampphase1_MSMF.app.restored.fits')
    noisearray = f[0].data.flatten()
    maxpixel = np.max(noisearray)
    noisearray = np.random.permutation(noisearray)[:10000]
    noisepix = np.array(filter(lambda x: abs(x) > 10E-8,noisearray))
    ...
    f = pyfits.open('image_ampphase1_MSMF.app.restored.fits.noisemap.fits')
    dataarray = f[0].data.flatten()
    dataarray = np.random.permutation(dataarray)[:10000]
    #dataarray = np.array(filter(lambda x: abs(x) > minthreshold,dataarray))
    dataarray = np.random.permutation(dataarray)[:10000]
    ...
    update_cleanmask('image_ampphase1_MSMF.app.restored.fits.mask.fits','image_ampphase1_MSMF.app.restored.fits.noisemap.fits','image_ampphase1_MSMF.app.restored.fits.mask.fits_deeper1',threshold2)
    ddf_image('image_ampphase1_MSMF_deeper1',o['mslist'],cleanmask='image_ampphase1_MSMF.app.restored.fits.mask.fits_deeper1',cleanmode='MSMF',threshold=5*threshold2,majorcycles=10,robust=o['robust'],reuse_psf=True,use_dicomodel=True,previous_image='image_ampphase1_MSMF',ddsols='killms_ap1',applysols='AP',colname=colname)
    make_mask('image_ampphase1_MSMF_deeper1.app.restored.fits',o['ga'])
    
    update_cleanmask('image_ampphase1_MSMF_deeper1.app.restored.fits.mask.fits','image_ampphase1_MSMF_deeper1.app.restored.fits.noisemap.fits','image_ampphase1_MSMF.app.restored.fits.mask.fits_deeper2',threshold3)
    ddf_image('image_ampphase1_MSMF_deeper2',o['mslist'],cleanmask='image_ampphase1_MSMF.app.restored.fits.mask.fits_deeper2',cleanmode='MSMF',threshold=5*threshold3,majorcycles=10,robust=o['robust'],reuse_psf=True,use_dicomodel=True,previous_image='image_ampphase1_MSMF_deeper1',ddsols='killms_ap1',applysols='AP',colname=colname)
    make_mask('image_ampphase1_MSMF_deeper2.app.restored.fits',o['ga'])
    
    update_cleanmask('image_ampphase1_MSMF_deeper2.app.restored.fits.mask.fits','image_ampphase1_MSMF_deeper2.app.restored.fits.noisemap.fits','image_ampphase1_MSMF.app.restored.fits.mask.fits_deeper3',threshold4)
    ddf_image('image_ampphase1_MSMF_deeper3',o['mslist'],cleanmask='image_ampphase1_MSMF.app.restored.fits.mask.fits_deeper3',cleanmode='MSMF',threshold=5*threshold4,majorcycles=10,robust=o['robust'],reuse_psf=True,use_dicomodel=True,previous_image='image_ampphase1_MSMF_deeper2',ddsols='killms_ap1',applysols='AP',colname=colname)
    make_mask('image_ampphase1_MSMF_deeper3.app.restored.fits',o['ga'])

    mask_dicomodel('image_ampphase1_MSMF_deeper3.DicoModel','image_ampphase1_MSMF_deeper3.app.restored.fits.mask.fits','image_ampphase1_MSMF_deeper3_masked.DicoModel')
    ...
    if o['full_mslist'] is None:
        ...
        threshold1 = 20e-3
        ddf_image('image_full_ampphase1_MSMF',o['mslist'],cleanmask='image_phase1_MSMF_deeper3.app.restored.fits.mask.fits',cleanmode='MSMF',threshold=threshold1,majorcycles=10,robust=o['robust'],ddsols='killms_f_ap1',applysols='AP',colname=colname,use_dicomodel=True,dicomodel_base='image_ampphase1_MSMF_deeper3')

        make_mask('image_full_ampphase1_MSMF.app.restored.fits',o['ga'])

        f = pyfits.open('image_full_ampphase1_MSMF.app.restored.fits')
        noisearray = f[0].data.flatten()
        maxpixel = np.max(noisearray)
        noisearray = np.random.permutation(noisearray)[:10000]
        noisepix = np.array(filter(lambda x: abs(x) > 10E-8,noisearray))
        ...
        f = pyfits.open('image_full_ampphase1_MSMF.app.restored.fits.noisemap.fits')
        dataarray = f[0].data.flatten()
        dataarray = np.random.permutation(dataarray)[:10000]
        #dataarray = np.array(filter(lambda x: abs(x) > minthreshold,dataarray))
        dataarray = np.random.permutation(dataarray)[:10000]
        ...
        update_cleanmask('image_full_ampphase1_MSMF.app.restored.fits.mask.fits','image_full_ampphase1_MSMF.app.restored.fits.noisemap.fits','image_full_ampphase1_MSMF.app.restored.fits.mask.fits_deeper1',threshold2)
        ddf_image('image_full_ampphase1_MSMF_deeper1',o['mslist'],cleanmask='image_full_ampphase1_MSMF.app.restored.fits.mask.fits_deeper1',cleanmode='MSMF',threshold=5*threshold2,majorcycles=10,robust=o['robust'],reuse_psf=True,use_dicomodel=True,previous_image='image_full_ampphase1_MSMF',ddsols='killms_f_ap1',applysols='AP',colname=colname)
        make_mask('image_full_ampphase1_MSMF_deeper1.app.restored.fits',o['ga'])
    
        update_cleanmask('image_full_ampphase1_MSMF_deeper1.app.restored.fits.mask.fits','image_full_ampphase1_MSMF_deeper1.app.restored.fits.noisemap.fits','image_full_ampphase1_MSMF.app.restored.fits.mask.fits_deeper2',threshold3)
        ddf_image('image_full_ampphase1_MSMF_deeper2',o['mslist'],cleanmask='image_full_ampphase1_MSMF.app.restored.fits.mask.fits_deeper2',cleanmode='MSMF',threshold=5*threshold3,majorcycles=10,robust=o['robust'],reuse_psf=True,use_dicomodel=True,previous_image='image_full_ampphase1_MSMF_deeper1',ddsols='killms_f_ap1',applysols='AP',colname=colname)
        make_mask('image_full_ampphase1_MSMF_deeper2.app.restored.fits',o['ga'])
    
        update_cleanmask('image_full_ampphase1_MSMF_deeper2.app.restored.fits.mask.fits','image_full_ampphase1_MSMF_deeper2.app.restored.fits.noisemap.fits','image_full_ampphase1_MSMF.app.restored.fits.mask.fits_deeper3',threshold4)
        ddf_image('image_full_ampphase1_MSMF_deeper3',o['mslist'],cleanmask='image_full_ampphase1_MSMF.app.restored.fits.mask.fits_deeper3',cleanmode='MSMF',threshold=5*threshold4,majorcycles=10,robust=o['robust'],reuse_psf=True,use_dicomodel=True,previous_image='image_full_ampphase1_MSMF_deeper2',ddsols='killms_f_ap1',applysols='AP',colname=colname)
