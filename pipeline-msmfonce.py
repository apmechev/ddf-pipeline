...
if __name__=='__main__':
    ...
    make_mask('image_dirin_MSMF_deeper3.app.restored.fits',o['ga'],use_tgss=True)
    
    # cluster to get facets
    if make_model('image_dirin_MSMF_deeper3.app.restored.fits.mask.fits','image_dirin_MSMF_deeper3'):
        # if this step runs, clear the cache to remove facet info
        clearcache(o['mslist'])

    # Now SSD clean with the new facets
    ddf_image('image_dirin_SSDm',o['mslist'],cleanmask='image_dirin_MSMF_deeper3.app.restored.fits.mask.fits',cleanmode='SSD',majorcycles=4,robust=o['robust'],previous_image='image_dirin_MSMF_deeper3',reuse_psf=True,reuse_dirty=True,peakfactor=0.05,colname=colname,clusterfile='image_dirin_MSMF_deeper3.npy.ClusterCat.npy')
